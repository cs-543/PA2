...
public final class Main extends ListActivity {
	...
	//Upload
	private static final int F_MENU_UPLOAD =  0xa0;			//context menu id
	//Download
	private static final int F_MENU_DOWNLOAD =  0xb0;		//context menu id
...
//    	menu.add(0, MENU_SPACE, 0, "Free space").setIcon(R.drawable.space);
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo info) {
        ...
        /* is it a file and is multi-select turned off */
    		...
    		menu.add(0, F_MENU_DOWNLOAD, 0, "Download File");
